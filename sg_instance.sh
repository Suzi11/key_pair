...
echo -e "${GREEN}      /  |        |            |      |                    ${plain}"
echo -e "${GREEN}     /   |        |            |      |                     ${plain}"
echo -e "${GREEN}    /    |        |            |      | ________                     ${plain}"
echo -e "${GREEN}   /     |        | t.me/HWY16 |                |           ${plain}"
echo -e "${GREEN}  / ____ |___     |            |                |   ${plain}"
echo -e "${GREEN}         |        |            |                |              ${plain}"
echo -e "${GREEN}         |         ————————————        —————————        |               ${plain}"
echo -e "${red}    Contact the developer https://t.me/HWY16 for more information    ${plain}"
echo -e "${yellow} ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ${plain}"
#else
#  echo -e "${red}Token is invalid or expired. Contact the developer https://t.me/HWY16 for more information.${plain}"
#fi"
